...
class _SignUpState extends State<SignUp> {
            ...
            children: <Widget>[
              ...
              Positioned(
                ...
                child: SvgPicture.string(
                  // Your SVG code for the background image
      ...
      child: SizedBox(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            ...
            filled: true,
            fillColor: userController.text.isEmpty
            ...
            suffix: Container(
              ...
              child: userController.text.isEmpty
                  ? const Center()
                  : const Icon(
                      Icons.check,
                      color: Colors.white,
  ...
  Widget signUpButton(Size size) {
    return GestureDetector(
      onTap: () {
        // Navigate to the MainScreen when the button is tapped
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) =>
                MainScreen(), // Replace MainScreen() with the actual widget
          ),
        );
      },
      child: Container(
